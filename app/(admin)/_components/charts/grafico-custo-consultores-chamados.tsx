                ...
                <ChartContainer config={chartConfig} className="w-full h-full max-h-[290px] aspect-square">
                    <ResponsiveContainer>
                        <AreaChart data={chartData}>
                            ...
                            />
                            <Area dataKey="consultores" type="natural" fill="url(#fillconsultores)"
                                  stroke="var(--color-consultores)" stackId="a"/>
                            <Area dataKey="chamados" type="natural" fill="url(#fillchamados)"
                                  stroke="var(--color-chamados)" stackId="a"/>
